...
int main() {
    ...
    int pointer = 0;
    string Menu [4] = {"Carbon Footprint", "Fast Fashion", "Types of energy" , "Exit"};
   ...
   while(true){
    ...
    while (true)
    {
        ...
        else if (GetAsyncKeyState(VK_RETURN) != 0)
        {
            ...
            {
                case 0:
                    cout << "\n\n\nStarting the carbon footprint quiz...";
                    Sleep (2000);
                    break;
                case 1:
                    cout << "\n\n\nStarting the fast fashion quiz...";
                    Sleep (1000);
                break;
                case 2:
                	  cout << "\n\n\nStarting the energy quiz...";
                      Sleep (1000);	
                case 3:
                    return 0;
                    break;
